...
const nbOfEltse = 300;
    ...
    firebase.database().ref('perangkat1/historykelembapantanah/1').limitToLast(nbOfElts2).on('value', ts_measures => {
    let timestamp = [];
    let nilai = [];
    ...
    ts_measures9.forEach(ts_measure9 => {
      ...
      var satu = {
        ...
        y: nilai,
        mode: 'linecolor',
        name: 'Kelembapan Tanah Hari Ke-1'
      };
      var dua = {
        x: timestamp1,
        y: nilai1,
    ...
    const layout = {
        title: '<b> Nilai Kelembapan Tanah Pada Lahan Pertanian Jagung </b>',
        titlefont: {
        ...
        yaxis: {
            title: '<b>Nilai Kelembapan Tanah (%) </b>',
            titlefont: {
                family: 'Courier New, monospace',
                size: 14,
                color: '#000'
