...
const nbOfEltsb = 300;
    ...
    firebase.database().ref('perangkat1/historysuhu/1').limitToLast(nbOfElts).on('value', ts_measures => {
    let timestamp = [];
    let nilai = [];
    ts_measures.forEach(ts_measure => {
     ...
     firebase.database().ref('perangkat1/historysuhu/2').limitToLast(nbOfEltsa).on('value', ts_measures1 => {
    let timestamp1 = [];
    let nilai1 = [];
    ...
    firebase.database().ref('perangkat1/historysuhu/3').limitToLast(nbOfEltsb).on('value', ts_measures2 => {
    let timestamp2 = [];
    let nilai2 = [];
    ...
    firebase.database().ref('perangkat1/historysuhu/4').limitToLast(nbOfEltsb).on('value', ts_measures3 => {
    let timestamp3 = [];
    let nilai3 = [];
    ...
    firebase.database().ref('perangkat1/historysuhu/5').limitToLast(nbOfEltsb).on('value', ts_measures4 => {
    let timestamp4 = [];
    let nilai4 = [];
    ...
    firebase.database().ref('perangkat1/historysuhu/6').limitToLast(nbOfEltsb).on('value', ts_measures5 => {
    let timestamp5 = [];
    let nilai5 = [];
    ...
    firebase.database().ref('perangkat1/historysuhu/7').limitToLast(nbOfEltsb).on('value', ts_measures6 => {
    let timestamp6 = [];
    let nilai6 = [];
    ...
    firebase.database().ref('perangkat1/historysuhu/8').limitToLast(nbOfEltsb).on('value', ts_measures7 => {
    let timestamp7 = [];
    let nilai7 = [];
    ...
    firebase.database().ref('perangkat1/historysuhu/9').limitToLast(nbOfEltsb).on('value', ts_measures8 => {
    let timestamp8 = [];
    let nilai8 = [];
    ...
    firebase.database().ref('perangkat1/historysuhu/10').limitToLast(nbOfEltsb).on('value', ts_measures9 => {
    let timestamp9 = [];
    let nilai9 = [];
    ts_measures9.forEach(ts_measure9 => {
      ...
      var tujuh = {
       ...
       var sepuluh = {
        x: timestamp9,
        y: nilai9,
        name: 'Suhu Hari Ke-10'
      };
       var data = [ satu , dua , tiga , empat , lima , enam , tujuh, delapan, sembilan, sepuluh];

    const layout = {
        title: '<b>NIlai Suhu Udara Pada Lahan Pertanian Jagung</b>',
        titlefont: {
